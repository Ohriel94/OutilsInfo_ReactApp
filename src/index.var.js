   ...
   628: (t, e, n) => {
       ...
       (n = [
        {
         ...
         value: function (t) {
          return this.icons.enabled
           ? ''.concat(this.icons.prefix).concat(this.icons[t]).concat(this.icons.suffix)
           : '';
         },
        },
        {
        ...
        },
        {
         ...
         value: function (t, e) {
          ...
          for (var r in t)
           e.hasOwnProperty(r)
            ? (n[r] = 'object' === o(t[r]) && null !== t[r] ? this.defaultsDeep(t[r], e[r]) : e[r])
            : (n[r] = t[r]);
          return n;
         },
        },
       ...
       },
       {
        ...
        value: function () {
         var t = this,
          ...
          n = 0;
         return (
          this.start && (n = this.options.minDurations[this.type] + this.start - Date.now()) < 0 && (n = 0),
     ...
     function a(t, e, n, o) {
      ...
      return (
       ...
       (r = i.call(
        this,
        o,
        ''.concat(l.prefix, '-').concat(Math.floor(Date.now() - 100 * Math.random())),
       ...
       },
       {
        ...
        get: function () {
         return this.duration <= 0 || 'async' === this.type
          ? ''
          : "<div class='"
             .concat(l.klass.progressBar, '\' style="animation-duration:')
    ...
    var P = (function (t) {
     ...
     function a(t) {
      ...
      return (
       ((e = i.call(this, document.body, f.ids.wrapper, null, s, o))[f.ids.confirmOk] = r),
          ...
          case 'confirm':
           ...
           !1 !== this[f.ids.confirmCancel] &&
            ...
            (e = ''
             ...
             .concat(this.options.label(this.type), '</div><div class="')
        ...
        value: function (t) {
         ...
         switch (t.code) {
          ...
          case 'Tab':
           ...
           var e = this.okBtn;
           t.shiftKey
            ? document.activeElement.id == f.ids.confirmOk && (e = this.cancelBtn)
            : document.activeElement.id !== f.ids.confirmCancel && (e = this.cancelBtn),
            e.focus();
         }
        },
       },
